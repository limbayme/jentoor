'use client';
export default function FormatStill({ kind, accent = '#8ba168' }: { kind: string; accent?: string }) {
  return <svg viewBox="0 0 500 360" style={{width:'100%',height:'100%',maxWidth:580}} role="img" aria-label={kind + ' static format study'}>
    <ellipse cx="250" cy="282" rx="168" ry="43" fill="#dedfcf" stroke="#94afa2" />
    ...
    : kind==='liquid' ? <g><path d="M224 82h52v47q37 20 37 46v101H187V175q0-26 37-46Z" fill="#c39759"/><path d="M216 77h68v28h-68Z" fill="#dfd1b8"/><path d="M188 192h124v59H188Z" fill="#f5efdf"/><text x="250" y="229" textAnchor="middle" fill={accent} fontSize="22">JT</text></g>
    ...
    <text x="250" y="326" fill="#8ba168" fontSize="11" fontFamily="monospace" textAnchor="middle">JENTOOR / FORMAT DEVELOPMENT</text>
  </svg>;
}
